...
#pragma warning( disable : 4100 ) // warning C4100: <variable name> : unreferenced formal parameter
#endif
bool PluginInterface::OnInternalPacket(InternalPacket *internalPacket, unsigned frameNumber, PlayerID remoteSystemID, RakNetTime time, bool isSend)
{
	return true;
}

bool PluginInterface::OnSendImmediate(const char* data, const unsigned bitsUsed) {
	return true;
}

void PluginInterface::OnRpcReceive(unsigned char id, RPCParameters* params) {
}
